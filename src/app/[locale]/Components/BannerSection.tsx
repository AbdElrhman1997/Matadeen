...
const BannerSection = () => {
  ...
  const renderCard = (
    ...
    <div
      key={key}
      className="bg-[var(--main)]/55 lg:px-6 md:px-3 p-3 lg:w-[24%] md:w-[45%] w-[90%] lg:min-h-[187px] md:min-h-[130px] text-start flex flex-col justify-center"
    >
      <p className="text-[#F8F8F8] lg:text-[21px] md:text-[16px]">{date}</p>
      <p className="text-[#F8F8F8] lg:text-[34px] md:text-[24px] mb-[2px]">
        {title}
      </p>
      <p className="text-[#F8F8F8] lg:text-[21px] md:text-[16px]">{subtitle}</p>
    </div>
  );
